...
input_file_path = 'results/outputs_scraping_cleaning_pos/output2.json'
output_file_path = 'testing/ngrams/speisennamen/mit-stop/speisenname_ngram3.txt' #ngrams/beschreibung/ohne-stop/beschreibung_ngram(1,2,3)_no.txt   ngrams/beschreibung/mit-stop/beschreibung_ngram(1,2,3).txt
