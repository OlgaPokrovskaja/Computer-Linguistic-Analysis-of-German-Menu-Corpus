...
input_file_path = 'ngrams/beschreibung/normal/mit-stop/beschreibung_ngram3.txt' #ngrams/beschreibung/mit-stop/beschreibung_ngram(1,2,3).txt, ngrams/beschreibung/ohne-stop/beschreibung_ngram1_no.txt
output_file_path = 'ngrams/beschreibung/lowercase/mit-stop/beschreibung_low_ngram3_sorted_copy.txt' #ngrams/beschreibung/ohne-stop/beschreibung_ngram1_sorted.txt   , ngrams/beschreibung/mit-stop/beschreibung_ngram1_sorted.txt
output_image_path = 'ngrams/beschreibung/lowercase/mit-stop/b_low_mitstop_3_sqrt.png' #ngrams/beschreibung/mit-stop/b_mit_stop_1.png  , ngrams/beschreibung/ohne-stop/b_no_3.png
