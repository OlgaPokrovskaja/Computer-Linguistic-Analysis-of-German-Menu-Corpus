...
input_file_path = 'results/outputs_scraping_cleaning_pos/output1.json'  #Pfad der Eingabedatei 
output_file_path = 'results/outputs_scraping_cleaning_pos/output2.json'  #Pfad der Ausgabedatei 
