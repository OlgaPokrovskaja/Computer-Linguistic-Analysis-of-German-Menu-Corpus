...
Code Starten ohne only_url_parse: python -m scrapy crawl speisen 
Code Starten mit only_url_parse: python -m scrapy crawl speisen  -o results/outputs_scraping_cleaning_pos/output1.json 
