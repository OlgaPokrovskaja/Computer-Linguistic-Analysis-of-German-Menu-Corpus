"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 10
...
input_file_name = 'methods/combine_outputs/full_output9.json'
output_file_name = 'methods/combine_outputs/full_output10.json'
file_name = 'results/outputs_language_aspects/compounds_adel_deutsch.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_compound_bind': get_value(ner_speise, 'splits_compound_adel'),
                        })
                        found_match = True
                        break
