"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 9
...
input_file_name = 'methods/combine_outputs/full_output8.json'
output_file_name = 'methods/combine_outputs/full_output9.json'
file_name = 'results/outputs_language_aspects/compounds_adel_deutsch_split.json'
...
with open(input_file_name, 'r', encoding='utf-8') as input_file, \
    ...
    #Suche nach einen Match durch den Restaurantnamen
    for entry in kombiniert2_data:
        restaurant_match = None
        for ner_entry in ner_tagging_data:
            if (entry['restaurantname'] == ner_entry['restaurantname']):  
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_prep': g['splits_prep'],
                            'splits_adj': g['splits_adj'],
                            'splits_dialekte': g['splits_dialekte'],
                            'splits_compound_split': get_value(ner_speise, 'splits_compound_adel_split')
                        })
                        found_match = True
                        break
