"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 3
...
input_file_name = 'methods/combine_outputs/full_output2.json'
output_file_name = 'methods/combine_outputs/full_output3.json'
file_name = 'results/outputs_language_aspects/personen_name.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_person_name': get_value(ner_speise, 'splits_person')
                        })
                        found_match = True
                        break
