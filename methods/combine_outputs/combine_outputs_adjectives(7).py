"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 7
...
input_file_name = 'methods/combine_outputs/full_output6.json'
output_file_name = 'methods/combine_outputs/full_output7.json'
file_name = 'results/outputs_language_aspects/adjectives.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_adj': get_value(ner_speise, 'splits_adjectives')
                        })
                        found_match = True
                        break
