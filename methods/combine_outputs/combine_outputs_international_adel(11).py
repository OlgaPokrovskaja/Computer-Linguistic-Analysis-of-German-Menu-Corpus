"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 11
...
input_file_name = 'methods/combine_outputs/full_output10.json'
output_file_name = 'results/output_full.json'
file_name = 'results/outputs_language_aspects/international_adel.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_compound_split': g['splits_compound_split'],
                            'splits_compound_bind': g['splits_compound_bind'],
                            'splits_inter_adel': get_value(ner_speise, 'international_adel_splits'),
                        })
                        found_match = True
                        break
