"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 2
...
input_file_name = 'methods/combine_outputs/full_output1.json'
output_file_name = 'methods/combine_outputs/full_output2.json'
file_name = 'results/outputs_language_aspects/personen_ruf.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_person_ruf': get_value(ner_speise, 'splits_person')
                        })
                        found_match = True
                        break
