"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 5
...
input_file_name = 'methods/combine_outputs/full_output4.json'
output_file_name = 'methods/combine_outputs/full_output5.json'
file_name = 'results/outputs_language_aspects/homemade.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_home': get_value(ner_speise, 'splits_hausgemacht')
                        })
                        found_match = True
                        break
