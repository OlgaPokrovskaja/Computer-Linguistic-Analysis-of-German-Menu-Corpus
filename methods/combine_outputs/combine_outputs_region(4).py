"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 4
...
input_file_name = 'methods/combine_outputs/full_output3.json'
output_file_name = 'methods/combine_outputs/full_output4.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_region': get_value(ner_speise, 'splits_region')
                        })
                        found_match = True
                        break
