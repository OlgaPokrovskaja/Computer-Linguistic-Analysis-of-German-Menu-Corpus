"""
Kombinieren der Teilkorpora zu einen gemeinsamen Korpus Teil 8
...
input_file_name = 'methods/combine_outputs/full_output7.json'
output_file_name = 'methods/combine_outputs/full_output8.json'
file_name = 'results/outputs_language_aspects/dialekte.json'
                ...
                for ner_speise in ner_speisen:
                    ...
                    if g['speisenname'] == ner_speise['speisenname'] and g_beschreibung == ner_beschreibung:
                        dishes.append({
                            ...
                            'splits_dialekte': get_value(ner_speise, 'homemade_splits')
                        })
                        found_match = True
                        break
