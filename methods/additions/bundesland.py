"""
Hinzufügen von deutschen Bundesländern anhand der PLZ
...
#Einlesen der csv Datei mit PLZ und Bundesland
def load_csv(csv_filename):
    ...
    with open(csv_filename, 'r', encoding='ISO-8859-1') as file:
        ...
        for row in reader:
            ...
            csv_data[bundesland] = {'plz': plz, 'bundesland': bundesland}
    return csv_data
...
def update_json(csv_data, json_filename, json_filename_new):
            ...
            for item in data:
                if 'adresse_plz' in item:
                    ...
                    if plz in csv_data:
                        ...
                        item['Bundesland'] = csv_data[plz]['bundesland']
    ...
    with open('not_found2.txt', 'w', encoding='utf-8') as file:
...
csv_filename = 'datasets/plz_de.csv'
json_filename = 'results/outputs_scraping_cleaning_pos/output7.json'
json_filename_new = 'results/outputs_scraping_cleaning_pos/output_basis.json'
