"""
Suche nach den Sprachaspekt Preposition (aufwertende Preposition "an" in Speisennamen und Speisenbeschreibungen)
...
output_file_name = 'results/outputs_language_aspects/preposition.json'
keywords_file_name = 'datasets/adp_keyword.txt'
    ...
    with open(output_file_name, 'w', encoding='utf-8') as output_file:
        ...
        for obj in json_data:
            ...
            for dish in obj["speisen"]:
                ...
                filtered_splits = set() # Sets für die gefundene Einträge

                #Suche nach den Keywords in den Speisennamen und Speisenbeschreibungen, falls eine POS-Tag Struktur von Nomen oder Eigennamen Zusammensetzungen mit Preposition "an" vorliegt
                for tags in [dish['pos_tags'], dish['pos_tags_s']]:
                    for i in range(len(tags) - 2):
                        ...
                        if tag1 == 'ADP' and (tag2 == 'NOUN' or tag2 == 'PROPN') or \
                        tag1 == 'ADP' and (tag3 == 'NOUN' or tag3 == 'PROPN'):
                            if speisen_doc != "":
                    ...
                    if split != "":
                        for keyword in keywords:
                            if re.search(r'\b' + re.escape(keyword) + r'\b', split):
                                filtered_splits.add(split)  # Füge den Split dem Set hinzu, um Duplikate zu vermeiden
                ...
                if filtered_splits:
                    filtered_dishes.append({
                        ...
                        'splits_prep': list(filtered_splits),  # Konvertieren des Sets in eine Liste
                        'preis': preis
                    })
