...
"""
Suche nach den Sprachaspekt Adjectives (aufwertende Adjektive in Speisennamen und Speisenbeschreibungen)
...
output_file_name = 'results/outputs_language_aspects/adjectives.json'
keywords_file_name = 'datasets/adjektive.txt'
    ...
    with open(output_file_name, 'w', encoding='utf-8') as output_file:
        ...
        for obj in json_data:
            ...
            for dish in obj["speisen"]:
                ...
                doc = (' '.join(speisen)).lower() # Liste in Text umwandeln
                doc2 = (' '.join(beschreiben)).lower() # Liste in Text umwandeln
                ...
                if filtered_splits:
                    filtered_dishes.append({
                        ...
                        'splits_adjectives': filtered_splits,
                        'preis': preis
                    })
