"""
Suche nach den Sprachaspekt Dialect (Verwendung von dialektaler Sprache Speisennamen und Speisenbeschreibungen)
...
output_file_name = 'results/outputs_language_aspects/dialekte.json'
keywords_file_name = 'datasets/dialekte.txt'
            ...
            for dish in obj["speisen"]:
                ...
                if filtered_splits:
                    filtered_dishes.append({
                        ...
                        'dialect_splits': filtered_splits,
                        'preis': preis
                    })
