"""
Suche nach den Sprachaspekt Region (Verwendung Erwähnungen der Stadt oder Bundeslandes des Restaurants Speisennamen und Speisenbeschreibungen)
...
output_file_name = 'results/outputs_language_aspects/region.json'
            ...
            for dish in obj["speisen"]:
                ...
                for split in splits:
                    if split != "":
                        ...
                        if re.search(r'\b' + re.escape(stadt) + r'\b', split):
                            filtered_splits.append(split)
                        elif re.search(r'\b' + re.escape(bundesland) + r'\b', split):
                            filtered_splits.append(split)
